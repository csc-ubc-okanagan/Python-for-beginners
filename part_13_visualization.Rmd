...
Notice also there is something called `mark_circle()` which is different than `mark_point()`.
...
Then, try looking at thee stacked vertically by typing `line & point`
...
Now, let's show all three plots together.

You can show more than two plots together as well. Try writing `line | point | box`.
